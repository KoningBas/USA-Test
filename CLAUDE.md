...
- `serve.mjs` lives in the `scripts/` folder. Start it in the background before taking any screenshots.
- If the server is already running, do not start a second instance.

## Screenshot Workflow
- Puppeteer is installed at `C:/Users/jbfok/AppData/Local/Temp/puppeteer-test/`. Chrome cache is at `C:/Users/jbfok/.cache/puppeteer/`.
...
- `screenshot.mjs` lives in the `scripts/` folder. Use it as-is.
